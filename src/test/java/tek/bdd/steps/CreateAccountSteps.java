...
public class CreateAccountSteps extends SeleniumUtility {
    ...
    public void fillUpCreateAccountForm() {
        ...
        sendText(CreateAccountPageObject.FIRST_NAME_INPUT, "Najeebullah");
        sendText(CreateAccountPageObject.LAST_NAME_INPUT, "Shinwari");
        ...
        sendText(CreateAccountPageObject.DATE_OF_BIRTH, "08/25/1990");
    }
    ...
    public void whenTheUserFillUpSignUpForm() {
        sendText(CreateAccountPageObject.USERNAME_INPUT, "Najeebullah");
        sendText(CreateAccountPageObject.PASSWORD_INPUT, "Najeebullah123$");
        sendText(CreateAccountPageObject.CONFIRM_PASSWORD_INPUT, "Najeebullah123");
    }
    ...
    public void fillUpCreateAccountFormPage() {
        ...
        sendText(CreateAccountPageObject.EMAIL_INPUT, "Najeebullah.shinwari34@gmail.com");
        selectFromDropDown(CreateAccountPageObject.PREFIX_SELECT, "Mr.");
        sendText(CreateAccountPageObject.FIRST_NAME_INPUT, "Najeebullah");
        sendText(CreateAccountPageObject.LAST_NAME_INPUT, "Shinwari");
        selectFromDropDown(CreateAccountPageObject.GENDER_SELECT, "Male");
